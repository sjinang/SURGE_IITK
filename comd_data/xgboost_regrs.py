...
while ind < 10:
    ...
    #print norm
    #rows = preprocessing.normalize(rows)
    #cols = preprocessing.normalize(cols , norm='max')
    #print cols[11]
    #printcols[0]
    X1 = cols[0:13]
    ...
    X_train, X_test, y_train, y_test = train_test_split(X, Y, test_size = 0.5, random_state=rd.randrange(1000)) 
    ...
    lin_reg_mod = XGBRegressor(n_estimators=500)
